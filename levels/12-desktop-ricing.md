...
Finish this level and you graduate: a certificate with your name, final stats, and badges, written to `~/.bashquest/<name>.certificate.txt`, plus a closing word from Tasmania. See [how to play](../getting-started/how-to-play.html#graduation) for what that looks like.
